...
const AdministratorsList = () => {
  ...
  const administratorsPerPage = 10;
  ...
  const pageCount = Math.ceil(filteredAdministrators.length / administratorsPerPage);
  const offset = currentPage * administratorsPerPage;
  const currentAdministrators = filteredAdministrators.slice(offset, offset + administratorsPerPage);
  ...
  return (
    <div className="flex flex-col h-full w-full p-5">
      <h1 className="text-xl font-bold mb-4">ADMINISTRATOR LIST</h1>
      ...
      <div className="flex-grow overflow-auto">
        <table className="min-w-full table-auto border-collapse">
          ...
          <tbody>
            {currentAdministrators.map((item, index) => (
      ...
      {isEditing && currentAdmin && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
          <div className="bg-white p-6 rounded shadow-lg w-1/3">
            <h2 className="text-2xl font-bold mb-4">Edit Administrator</h2>
            <div className="mt-4">
