...
const Login = () => {
    const [state, setState] = useState('Admin'); // Options: 'Admin', 'Teacher', 'Student', 'Employee'
    ...
    const onSubmitHandler = async (event) => {
        ...
        try {
            const { endpoint, tokenSetter, localStorageKey } = roleConfig[state];
            ...
            if (data.success) {
                ...
                // No navigation here! App.jsx will handle it
            } else {
